...
public class ColorUtils {
	...
	public String getColorNameFromRgb1() throws IOException {
		
		File file= new File("D:\\Decathlon\\Decathlon_Cucumber_Framework\\Color_Screenshots\\myTest.png");
		  BufferedImage image = ImageIO.read(file);
		  // Getting pixel color by position x and y 
		  int clr=  image.getRGB(10,10); 
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println(colorUtils.getColorNameFromRgb1());
	}
}
